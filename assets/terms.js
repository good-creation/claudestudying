...
(function(){
  ...
  var TERMS = [
    ...
    /* --- 教育者のための AI Fluency --- */
    ['思考パートナー','thinking partner','AIを単なる道具ではなく、一緒に考える相手として扱う関わり方。'],
    ['教育コンテキストドキュメント','teaching context document','自分の教育観・担当科目・学生像・制約をまとめた再利用可能な文書。AIとの会話の冒頭で渡して共通理解の土台にする。'],
